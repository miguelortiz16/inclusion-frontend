...
interface EducationalImageFormData {
  grade: string;
  subject: string;
  topic: string;
  customGrade?: string;
...
export default function EducationalImages() {
  const [formData, setFormData] = useState<EducationalImageFormData>({
    grade: "",
    subject: "",
    topic: "",
  })
  ...
  const handleInputChange = (field: keyof EducationalImageFormData, value: string) => {
  ...
  const downloadImage = () => {
    ...
    link.download = `imagen-educativa-${formData.topic.toLowerCase().replace(/\s+/g, '-')}.png`
    ...
    try {
      if (navigator.share) {
        await navigator.share({
          title: `Imagen Educativa - ${formData.topic}`,
          text: `¡Mira esta imagen educativa sobre ${formData.topic}!`,
  ...
  const isFormValid = () => {
    return formData.grade && formData.subject && formData.topic
  }
      ...
      <Layout>
          ...
          >
            ...
            >
              <div className="flex items-center gap-4">
                <RiFileDownloadLine className="w-8 h-8 text-purple-500" />
                <h1 className="text-2xl font-bold text-gray-900">Generador de Imágenes Educativas</h1>
              </div>
              {imageData && (
              ...
              {isImageLoading ? (
                ...
                >
                  ...
                  <p className="text-center text-sm">
                    Completa el formulario de la derecha para generar una imagen educativa.
                  </p>
                </motion.div>
              )}
            </motion.div>
          ...
          >
            ...
            >
              <motion.div 
                ...
                className="flex justify-between items-center mb-6"
              >
                <h2 className="text-xl font-semibold">Generador de Imágenes</h2>
                <Dialog>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      <DialogTitle>Guía para Generar Imágenes Educativas</DialogTitle>
                      <DialogDescription>
                        <div className="space-y-4 mt-4">
                          <div>
                            ...
                            <ul className="list-disc list-inside mt-2 space-y-1">
                              ...
                              <li>Asignatura</li>
                              <li>Descripción detallada del tema</li>
                            </ul>
                          </div>
                          <div>
                            <h3 className="font-medium">Características de la imagen:</h3>
                            <ul className="list-disc list-inside mt-2 space-y-1">
                              <li>Alta calidad y resolución</li>
                              <li>Diseño adaptado al nivel educativo</li>
                              <li>Contenido educativo claro y preciso</li>
                              <li>Estilo visual apropiado para el contexto educativo</li>
                            </ul>
                          </div>
                        </div>
                      </DialogDescription>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Describe detalladamente el tema que quieres ilustrar</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </div>
        ...
        <Dialog open={showPreviewModal} onOpenChange={setShowPreviewModal}>
          <DialogContent className="max-w-4xl h-[90vh]">
            <DialogHeader>
              <DialogTitle>Previsualización de la Imagen</DialogTitle>
            </DialogHeader>
            <div className="overflow-y-auto h-full">
              {isImageLoading ? (
                ...
                <div className="border border-dashed rounded-lg p-8 flex flex-col items-center justify-center text-gray-500">
                  ...
                  <p className="text-center mb-2">No hay imagen generada</p>
                  <p className="text-center text-sm">
                    Completa el formulario para generar una imagen educativa.
                  </p>
                </div>
              )}
            </div>
