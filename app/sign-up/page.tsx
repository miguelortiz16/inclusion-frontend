  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/popup-closed-by-user') {
        // No mostrar error si el usuario cierra la ventana
        return;
      }
  ...
  const handleFacebookSignUp = async () => {
    ...
    try {
      ...
      if (userCredential.user) {
        ...
        toast.success("Registro con Facebook exitoso");
        router.push("/onboarding");
      }
    } catch (error: any) {
      console.error("Error en registro:", error);
      ...
      toast.error(error.message || "Error al registrarse con Facebook");
    } finally {
      setLoading(false);
    }
  }
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            {loading ? "Registrando..." : "Continuar con Facebook"}
          </Button> */}
